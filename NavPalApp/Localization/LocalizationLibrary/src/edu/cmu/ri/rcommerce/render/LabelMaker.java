...
public class LabelMaker {
     ...
     */
    /*
    public void beginDrawingPixelCoords(GL10 gl, float viewWidth, float viewHeight) {
     ...
     * @param labelID
     */
    public void draw(GL10 gl, float screenX, float screenY, int labelID) {
        checkState(STATE_DRAWING, STATE_DRAWING);
        gl.glPushMatrix();
        float snappedX = (float) Math.floor(screenX);
        float snappedY = (float) Math.floor(screenY);
     ...
     */
    /*
    public void endDrawingPixelCoords(GL10 gl) {
