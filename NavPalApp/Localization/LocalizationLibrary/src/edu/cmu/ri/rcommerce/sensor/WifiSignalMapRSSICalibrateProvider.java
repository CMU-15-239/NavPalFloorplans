 ...
 * @author Nisarg
 */
public class WifiSignalMapRSSICalibrateProvider implements RSSICalibrateProvider<Particle2D> {
	List<CorrelatedSignalValues> data;
	public WifiSignalMapRSSICalibrateProvider(BufferedReader input) throws IOException {
	...
	public List<RSSIReading> getExpectedReadings(Particle2D particle) {
		...
		out.add(closestDataPoint.toRSSIReadingWifi());
		return out;
	}
