 ...
 * 
 */
public class CalibrateGyroActivity extends Activity
{
	...
	myHandler.postDelayed(new Runnable()
	{
	    ...
	    public void run()
	    {
		GyroCalibrationDataProvider.setGyroCalibrationData(new float[]
		{ data[0] / calibrateTime, data[1] / calibrateTime, data[2] / calibrateTime });
